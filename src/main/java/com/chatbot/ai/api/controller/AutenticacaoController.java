package com.chatbot.ai.api.controller;

import com.chatbot.ai.api.dtos.Request.AutenticacaoRequest;

import com.chatbot.ai.api.dtos.Response.AutenticacaoResponse;
import com.chatbot.ai.api.exceptionsHandler.ExceptionMessage;
import com.chatbot.ai.core.security.TokenService;
...
public class AutenticacaoController {
    ...
    @PostMapping("/login")
        public ResponseEntity<AutenticacaoResponse> autenticar(@RequestBody @Valid AutenticacaoRequest autenticacaoDto) {
            ...
            System.out.println("o user: " +  senhaDoUsuario);
